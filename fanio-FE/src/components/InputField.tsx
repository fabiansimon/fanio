  ...
  ({isLoading, trailing, ...props}, ref) => (
    <div className="flex relative">
      <input
        ...
        type="text"
        className={UI.cn(
          'relative bg-transparent pb-1 flex text-2xl text-white flex-grow font-medium text-left focus:outline-none focus:border-b-1 focus:border-white/70 border-b-[1.5px] border-b-white/10 placeholder-neutral-600',
          props.className,
        )}
      />
